...
#        )
    ...
    # Get predections
    preds_iter = model.predict(gluon_train)
    y_hats = [ts.samples[1].reshape(prediction_length+2) for ts in preds_iter]
    ...
    # Compute errors
#    y_hats_6day = pd.concat([train_6day.iloc[ :, -1:],
#                             train_6day.iloc[ :, -1:],
#                             train_6day.iloc[ :, -1:],
#                             train_6day.iloc[ :, -1:],
#                             train_6day.iloc[ :, -1:],
